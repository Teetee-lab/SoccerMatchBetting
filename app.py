...
spi1 = st.slider("What is the home team's ESPN SPI rating?", 
                 min_value=1.00, max_value=99.00)
...
season = st.slider("What season is the match",
                 min_value=2016, max_value=2022)

xg1 = st.slider("What is the expected goals on the Home team?",
                 min_value=0.01, max_value=5.00)

xg2 = st.slider("What is the expected goals on the Away team?",
                 min_value=0.01, max_value=5.00)

importance1 = st.slider("How important is the match to the Home team?",
                 min_value=1.00, max_value=99.00)

importance2 = st.slider("How important is the match to the Away team?",
                 min_value=1.00, max_value=99.00)
